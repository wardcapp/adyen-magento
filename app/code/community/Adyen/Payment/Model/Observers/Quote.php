...
class Adyen_Payment_Model_Observers_Quote
{
     ...
     * @return $this
     */
    protected function _salesQuoteItemSetIsSampleAttribute(Varien_Event_Observer $observer)
    {
        ...
        $quoteItem->setAdyenPreOrder($product->getAdyenPreOrder()); // set if product is pre order
    }
}
