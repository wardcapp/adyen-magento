 ...
 */
class Adyen_Payment_Block_Form_CcInstallment extends Mage_Payment_Block_Form_Cc
{

    protected function _construct()
    {
        parent::_construct();
        $this->setTemplate('adyen/form/cc_installment.phtml');
    ...
    public function showPassword() {
        ...
        if( $this->_getQuote()->getData('checkout_method') == 'guest' && (!$customer->getId() && !Mage::getSingleton('customer/session')->isLoggedIn()) ) {
            return true;
        } else {
            return false;
        }
